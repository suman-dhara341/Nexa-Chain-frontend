        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <motion.div
              ...
              className="md:col-span-2 bg-white border border-slate-200/80 rounded-2xl p-6 sm:p-8 shadow-[0_2px_10px_rgb(0,0,0,0.02)] flex flex-col justify-center"
            >
              ...
              <div className="flex items-center justify-between bg-slate-50 border border-slate-200 rounded-xl p-2 max-w-md transition-colors hover:border-slate-300">
                <span className="text-xl sm:text-2xl font-black tracking-widest text-slate-900 pl-4 py-1">
                  {userReferralCode || "------"}
                </span>

                <button
                  onClick={handleCopyCode}
                  className={`flex items-center gap-2 px-4 py-2.5 rounded-lg font-bold text-xs transition-all duration-200 ${
                    copied
            ...
            <motion.div
              ...
              className="md:col-span-1 bg-slate-900 border border-slate-800 rounded-2xl p-6 sm:p-8 shadow-lg relative overflow-hidden flex flex-col justify-center"
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-2 mb-6">
                  <LuUsers className="text-indigo-400" size={18} />
                ...
                <p className="text-slate-500 text-xs font-medium mt-3 border-t border-slate-800 pt-3">
